...
distanceCutoffs="6.0 8.0 10.0"
gammas="0.25"
projections="True"
alignstyle="2bindividual"
projectionstyles="full"
rescaleEigenvalues="True False"
            ...
            do
              ...
              do
                ...
                do
                    ...
                    experimentNamePrefix="2b_individual_"$RMSDreduction"_"$measureOnWholeLiteral"_"$resolution"_"$potential"_model"$customHIndividual"_lambdaR"$lambdaR"_d"$d"_gamma"$gamma"_projection"$projection"_projectionStyle"$projectionstyle"_align"$alignstyle
                    ...
                    while read line; do
                        ...
                        qsub -cwd -N "j2b_individual_"$customHIndividual"_"$measureOnWholeLiteral"_"$resolution"_"$potential"_lambdaR"$lambdaR"_d"$d"_gamma"$gamma"_projection"$projection"_projectionStyle"$projectionstyle"_align"$alignstyle runme.sge
                        rm runme.sge
                        rm proteinPaths.txt
                        rm proteinBatch.txt
                        rm proteinBatchNoPath.txt
